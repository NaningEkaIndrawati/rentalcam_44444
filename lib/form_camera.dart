...
class FormCamera extends StatefulWidget {
  ...
  @override
  _FormCameraState createState() => _FormCameraState();
}
...
class _FormCameraState extends State<FormCamera> {
  ...
  void buildPricePerHour() {
    String harga6 = "6 Jam : ${kamera.harga6}";
    String harga12 = "12 Jam : ${kamera.harga12}";
    String harga24 = "24 Jam : ${kamera.harga24}";
            ...
            trailing: DropdownButton<String>(
              ...
              onChanged: (String? value) {
                setState(() {
                  ...
                  _showPaymentInfo = value == 'Transfer';
                });
              },
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Text(
                'Isi formulir penyewaan Camera ${kamera.namaAlat}',
                style: TextStyle(
                  fontSize: 20.0,
            ...
            if (_showPaymentInfo && selectedMethodePembayaran == 'Transfer')
              informasiPembayaran(),
            SizedBox(
              height: 32,
            ),
