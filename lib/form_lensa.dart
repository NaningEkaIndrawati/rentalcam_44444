...
class FormLensa extends StatefulWidget {
  Data lensa;

  FormLensa({required this.lensa});

  @override
  _FormLensaState createState() => _FormLensaState();
}

class _FormLensaState extends State<FormLensa> {
  ...
  void buildPricePerHour() {
    String harga6 = "6 Jam : ${lensa.harga6}";
    String harga12 = "12 Jam : ${lensa.harga12}";
    String harga24 = "24 Jam : ${lensa.harga24}";
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Text(
                'Isi formulir penyewaan Camera ${lensa.namaAlat}',
                style: TextStyle(
                  fontSize: 20.0,
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                String idAlat = lensa.id.toString();
