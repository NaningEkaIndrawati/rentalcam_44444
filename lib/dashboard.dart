import 'package:belajar/Api/notifikasi.dart';
...
class _NotifikasiPageState extends State<NotifikasiPage> {
  late Future<List<Notifications>> _futureNotifications;

  @override
  void initState() {
    super.initState();
    // Panggil API untuk mendapatkan notifikasi
    _futureNotifications = NotifikasiApi.getNotification();
  }
      ...
      body: FutureBuilder<List<Notifications>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(
                child: Text('Error: ${snapshot.error}')); // Menampilkan error
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _buildNotificationCard(
                  icon: Icons.notifications, // Anda bisa menyesuaikan ikon
